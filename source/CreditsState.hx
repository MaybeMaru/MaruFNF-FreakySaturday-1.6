...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...creditsStuff.length)
		{
			...
			var optionText:Alphabet = new Alphabet(-5, 70 * i, creditsStuff[i][0], !isSelectable, false);
		...
		descBox.xAdd = -10;
		descBox.yAdd = -10;
		descBox.alphaMult = 0.9;
		descBox.alpha = 0.9;
		add(descBox);

		descText = new FlxText(250, FlxG.height + offsetThing - 25, 800, "", 32);
